...
$Env:PAPER_SEARCH_MCP_PORT = If ($Env:PAPER_SEARCH_MCP_PORT) { $Env:PAPER_SEARCH_MCP_PORT } Else { "50002" }

$Env:SIMULATION_MCP_HOST = If ($Env:SIMULATION_MCP_HOST) { $Env:SIMULATION_MCP_HOST } Else { "0.0.0.0" }
$Env:SIMULATION_MCP_PORT = If ($Env:SIMULATION_MCP_PORT) { $Env:SIMULATION_MCP_PORT } Else { "50003" }

$Env:DATABASE_MCP_HOST = If ($Env:DATABASE_MCP_HOST) { $Env:DATABASE_MCP_HOST } Else { "0.0.0.0" }
$Env:DATABASE_MCP_PORT = If ($Env:DATABASE_MCP_PORT) { $Env:DATABASE_MCP_PORT } Else { "50010" }
